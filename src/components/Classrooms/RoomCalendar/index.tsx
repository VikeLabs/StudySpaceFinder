...
const RoomCalendar: React.FC = () => {
    ...
    const [building, setBuilding] = useState<string | null>(params.get('building'))
    ...
    function createCalendarEvent(startTime: string, endTime: string, name: string, day: string): any {
    ...
    return (
        <Container>
            <PageTitle name={data ? building + " " + room  + " Weekly Schedule" : ""}/>
