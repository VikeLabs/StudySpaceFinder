    ...
    return(
        ...
        <Container>
            ...
            <div className={styles.dropdownContainer}>
                <Dropdown label="Time" value={timeValue} options={timeOptions} onChange={handleTimeChange}/>
                <Dropdown label="Day" value={dayValue} options={dateOptions} onChange={handleDayChange}/>
            </div>
            <div  className={styles.ClassroomCardsContainer}>
                { data && Object.keys(data).map((key: any, index: number) => {
                    return (
                        isClassAvailable(building, key) ? 
                        <ClassroomCard 
                            name={key} 
                            data={data[key]} 
                            day={dayValue} 
